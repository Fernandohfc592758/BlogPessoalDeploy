...
public class UsuarioControllerTest {
	...
	// somente no teste de controlller, pois usamos o padrão rest que utiliza dos
	// verbos e metodos HTTP -> GET-POST-PUT-DELETE
	@Autowired
...
//comecei a partir daqui
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria da Silva", "maria_silva@email.com.br", "123456789",
				"https://i.imgur.com/FETvs21.jpg"));
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, "Maria da Silva",
				"maria_silva@email.com.br", "123456789", "https://i.imgur.com/FETvs21.jpg"));
		ResponseEntity<Usuario> resposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST, requisicao,
				Usuario.class);
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(
				new Usuario(0L, "Juliana Andrews", "juliana_andrews@email.com.br", "juliana123", "ssssssss"));

		Usuario usuarioUpdate = new Usuario(usuarioCreate.get().getId(), "Juliana Andrews Ramos",
				"juliana_ramos@email.com.br", "juliana123", "ssssssss");
